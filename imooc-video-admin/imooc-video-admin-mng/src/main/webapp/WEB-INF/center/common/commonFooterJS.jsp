...
<%--<input type="hidden" id="apiServer" name="apiServer" value="http://192.168.0.105:8081"/>--%>
 <input type="hidden" id="apiServer" name="apiServer" value="http://www.liqipeter.com/v"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://111.231.243.149/mvc"/>
